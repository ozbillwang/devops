...
function test() {
    eg.auth({
        path: "/papi/v0/properties/prp_373155/versions/1/hostnames/?contractId=ctr_C-1FRYVV3&groupId=grp_68817",
        method: "GET",
...
function test2() {
    eg.auth({
        path: "/papi/v0/properties/prp_376536/versions/43/hostnames/?contractId=ctr_C-1FRYVV3&groupId=grp_68817",
        method: "GET",
        headers: { 'Content-Type': 'application/json' },
    });
